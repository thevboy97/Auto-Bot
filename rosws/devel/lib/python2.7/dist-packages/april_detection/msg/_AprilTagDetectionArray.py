...
"""autogenerated by genpy from april_detection/AprilTagDetectionArray.msg. Do not edit."""
import codecs
import sys
...
import april_detection.msg
import geometry_msgs.msg
import std_msgs.msg

class AprilTagDetectionArray(genpy.Message):
  _md5sum = "3ab7cc88f4b1f1ec383798e746c860c7"
  _type = "april_detection/AprilTagDetectionArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','april_detection/AprilTagDetection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = april_detection.msg.AprilTagDetection()
        _v6 = val1.header
        start = end
        end += 4
