...
if("TRUE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /root/rosws/src/image_pipeline/image_publisher)
  set(image_publisher_DEVEL_PREFIX /root/rosws/devel)
  ...
  set(image_publisher_INSTALL_PREFIX /root/rosws/install)
...
if(NOT "/root/rosws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/rosws/src/image_pipeline/image_publisher/${idir}'.  ${_report}")
    endif()
