...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name april_detection-msg:<AprilTagDetection> is deprecated: use april_detection-msg:AprilTagDetection instead.")))
...
(cl:defmethod id-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader april_detection-msg:id-val is deprecated.  Use april_detection-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'corners2d-val :lambda-list '(m))
(cl:defmethod corners2d-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader april_detection-msg:corners2d-val is deprecated.  Use april_detection-msg:corners2d instead.")
  (corners2d m))

(cl:ensure-generic-function 'tag_size-val :lambda-list '(m))
(cl:defmethod tag_size-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader april_detection-msg:tag_size-val is deprecated.  Use april_detection-msg:tag_size instead.")
  (tag_size m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader april_detection-msg:pose-val is deprecated.  Use april_detection-msg:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AprilTagDetection>)))
  ...
  "april_detection/AprilTagDetection")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AprilTagDetection)))
  "Returns string type for a message object of type 'AprilTagDetection"
  "april_detection/AprilTagDetection")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AprilTagDetection>)))
  ...
  "4bc382ffa5b7bebdf644ee8fcb36b889")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AprilTagDetection)))
  "Returns md5sum for a message object of type 'AprilTagDetection"
  "4bc382ffa5b7bebdf644ee8fcb36b889")
