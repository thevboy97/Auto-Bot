...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /root/rosws/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /root/rosws/devel)
  ...
  set(image_proc_INSTALL_PREFIX /root/rosws/install)
...
if(NOT "/root/rosws/devel/include;/root/rosws/src/image_pipeline/image_proc/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/root/rosws/devel/include;/root/rosws/src/image_pipeline/image_proc/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/rosws/src/image_pipeline/image_proc/${idir}'.  ${_report}")
    endif()
